...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2026. Jan 16. 08:25
...
INSERT INTO `film_type` (`film_type_id`, `name`) VALUES
(1, 'Action'),
(2, 'Comedy'),
(3, 'Drama'),
(4, 'Sci-Fi'),
...
--
ALTER TABLE `film_type`
  MODIFY `film_type_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
ALTER TABLE `movies`
  ...
  ADD CONSTRAINT `movies_ibfk_2` FOREIGN KEY (`film_type_id`) REFERENCES `film_type` (`film_type_id`);
COMMIT;
